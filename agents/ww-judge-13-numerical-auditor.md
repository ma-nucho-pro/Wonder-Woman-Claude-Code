---
name: ww-judge-13-numerical-auditor
description: Wonder Woman 13 numerical auditor. Use only when the Wonder Woman coordinator dispatches this specialist verification judge.
model: inherit
---
