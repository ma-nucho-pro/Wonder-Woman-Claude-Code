---
name: ww-judge-10-logic-auditor
description: Wonder Woman 10 logic auditor. Use only when the Wonder Woman coordinator dispatches this specialist verification judge.
model: inherit
---
