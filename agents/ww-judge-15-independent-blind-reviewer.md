---
name: ww-judge-15-independent-blind-reviewer
description: Wonder Woman 15 independent blind reviewer. Use only when the Wonder Woman coordinator dispatches this specialist verification judge.
model: inherit
---
