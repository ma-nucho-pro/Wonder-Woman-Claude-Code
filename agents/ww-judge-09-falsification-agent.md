---
name: ww-judge-09-falsification-agent
description: Wonder Woman 09 falsification agent. Use only when the Wonder Woman coordinator dispatches this specialist verification judge.
model: inherit
---
